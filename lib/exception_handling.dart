...
/// This sample app shows how to use 'GoRouter.onException' to redirect on exception.
///
/// The first route is '/' is mapped to [HomeScreen],
/// and the second route '/404' is mapped to [NotFoundScreen]
///
