...
// which is a pattern where an additional Navigator is placed in the widget tree to be used instead of the root navigator.
// This allows deep-links to display pages along with other UI components such as a BottomNavigationBar.
...
class ScaffoldWithNavBar extends StatelessWidget {
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.business), label: 'B Screen'),
          BottomNavigationBarItem(
              icon: Icon(Icons.notification_important_rounded),
              label: 'C Screen'),
        ],
        currentIndex: _calculateSelectedIndex(context),
        onTap: (currentIndex) => _onItemTapped(currentIndex, context),
      ),
    );
  }
  ...
  static int _calculateSelectedIndex(BuildContext context) {
    ...
    log(location, name: "full location");
